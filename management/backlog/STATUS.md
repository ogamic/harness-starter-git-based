...
|----|-------|----------|--------|--------|
| [0001](0001-example-settings-screen.md) | Add a settings screen to the web app *(example ticket — delete when you start)* | Medium | Open — worked example showing the template | app |
