...
Verified: <build: green (tool)>  ·  <device/simulator: what was observed, or "not run — no device">
...
Flag when runtime was not exercised on a device/simulator — a green build alone is not "done" for UI work.
