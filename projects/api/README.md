# api — backend service (example stub)

A worked example sub-project. Replace it with your own backend, or delete it once you've learned the pattern.

- **Stack:** Node · Express · TypeScript · Postgres
- **Owned by:** the `api` sub-agent (`../../management/agents/api.md`)
